...
@JsonIdentityInfo(generator=ObjectIdGenerators.PropertyGenerator.class,property="id" , scope = Certificado.class)
public class Certificado {
	...
	private Solicitud idSolicitud;
	 ...
	 @OneToMany(cascade = CascadeType.ALL, mappedBy = "idCertificado",orphanRemoval = true)
